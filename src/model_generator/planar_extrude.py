#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""平面拉伸建模器 — 支持 direct 和 subprocess 双模式。"""
...
class PlanarExtrudeModeler:
    ...
    def generate(self, geometry_data: Dict[str, Any], relationships: Dict[str, Any]) -> 'PlanarExtrudeModeler':
    ...
    def _generate_direct(self, geometry_data: Dict[str, Any], relationships: Dict[str, Any]) -> 'PlanarExtrudeModeler':
    ...
    def _generate_via_bridge(self, geometry_data: Dict[str, Any],
                              relationships: Dict[str, Any]) -> 'PlanarExtrudeModeler':
